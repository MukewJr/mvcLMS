...
//    public  String getAllStudents(@RequestParam("companyId")Long id, Model model){
...
//    public String saveStudent(@RequestParam("courseId")Long id,@ModelAttribute("course") Student student){
