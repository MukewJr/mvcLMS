...
public class LessonController {
    ...
    private String getAllLessons(@PathVariable("courseId")Long courseId, Model model) {
        model.addAttribute("allLessons",service.getAllLessons(courseId));
    ...
    private String saveUpdateLesson(@PathVariable("courseId")Long courseId, @PathVariable("lessonId")Long lessonId,
